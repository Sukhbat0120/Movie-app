export const Footer = () => {
  return (
    <footer className="bg-indigo-700 h-[200px] pt-10 flex justify-around">
      <div>
        <div className="flex gap-2">
          ...
          <p className="text-[#FAFAFA] content-center text-[16px] font-bold">
            Movie Z
          </p>
        </div>
      ...
      <div>
        <p className="text-[#FAFAFA] font-semibold">Contact Information</p>
        ...
        <div className="flex gap-1">
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_25593_5099)">
              <path
      ...
      <div>
        <p className="text-[#FAFAFA] font-semibold">Follow us</p>
        <div className="flex gap-3">
          <p className="text-[#FAFAFA]">Facebook</p>
          <p className="text-[#FAFAFA]">Instagram</p>
          <p className="text-[#FAFAFA]">Twitter</p>
          <p className="text-[#FAFAFA]">Youtube</p>
        </div>
      </div>
    </footer>
  );
